 class CountryRunner
 {
	 public static void main(String[]args)
	 {
	     ...
	     Country.primeministerBackward(ministersNo);
	     ...
	     Country.ministerNoBackward(cabinetministers);
		 String[] politicalparties={"BJP","INC","AAP" ,"TMC" , "BSP"};
		 Country.chargerBackward(politicalparties);
	 }
 }